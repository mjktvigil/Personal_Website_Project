...
Option 1: Copy-paste your HTML document here
...
<!-- Start Side Navigation -->
    ...
    <div class="container">
      <div class="column">
        ...
        </div><!-- .col-md-5 image-service-box -->
      </div><!-- column-fluid -->
      <!-- End Side Navigation -->
			...
			<div class="col-lg-12">
				...
				<div class="row">
					...
					<ul id="thumbs" class="portfolio">
						...
						<span class="overlay-img-thumb">Portfolio name</span>
						</a>
			...
			<div class="col-lg-3">
				<div class="widget">
					...
					<ul class="social-network">
						...
						<li><a href="https://www.linkedin.com/in/mariejtvigil" data-placement="top" title="Linkedin"><i class="fa fa-linkedin"></i></a></li>
						
						<li><a href="https://plus.google.com/u/0/111062279938596830993/posts" data-placement="top" title="Google plus"><i class="fa fa-google-plus"></i></a></li>
                        <li><a href="#" data-placement="top" title="GitHub"><i class="fa-github-alt"></i></a></li>
                        <!--<li><a href="#" data-placement="top" title="Facebook"><i class="fa fa-facebook"></i></a></li>
                        <li><a href="#" data-placement="top" title="Pinterest"><i class="fa fa-pinterest"></i></a></li>
					</ul>-->
					<div class="clear"><!--for added whitespace and color between footer and subfooter-->
					</div>
				</div>
			</div>
		</div>
