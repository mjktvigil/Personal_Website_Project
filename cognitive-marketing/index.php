...
<html lang="en-US">
  <head>
    ...
    <!-- fa fa-share-square-o icon -->
    <link href="../css/font-awesome.min.css" rel="stylesheet">
    <!-- google fonts -->
    <link href='https://fonts.googleapis.com/css?family=Raleway:400,500|Dancing+Script|Pontano+Sans|Lekton' rel='stylesheet' type='text/css'>
  ...
  <body class="body-background">
    ...
    <!-- Start Main Content --
      <!-- Start Portfolio Intoduction -->
    <!-- Start Portfolio Intoduction -->
    <div class="container">
      <div class="center">
        <h1>Cognitive Marketing</h1>
        <p class="paragraph">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut <br> et dolore magna aliqua. Ut enim ad minim veniam</p>
      </div><!-- .center -->
    </div>
    <!-- container-->
    <!-- End Portfolio Intoduction -->
    ...
    <div class="container">
            ...
            <div class="squish-container">
              <nav class="example-menu">
                <ul>
                  ...
                  <li class="example-menu3"><a href="index.php"><strong>Cognitive Marketing </strong></a></li>
                </ul>
              </nav><!-- .example-menu -->
      ...
      </article><!-- End Portfolio Intoduction Article -->
    </div><!-- .container -->
    <!-- End article -->
    <!-- Start Portfolio Section-->
    <section id="portfolio">
      <div class="center container">
        <!-- Start Portfolio-Category Filter Menu -->
        <ul class="portfolio-filter text-center">
          <li><a class="btn btn-default active" href="#" alt="???" title="" data-filter="*">All Works</a></li>
          <li><a class="btn btn-default" href="#" alt="???" title="" data-filter=".bootstrap">Creative</a></li>
          <li><a class="btn btn-default" href="#" alt="???" title="" data-filter=".html">Photography</a></li>
          <li><a class="btn btn-default" href="#" alt="???" title="" data-filter=".wordpress">Web Development</a></li>
        </ul><!--#portfolio-filter-->
        <!-- End Portfolio-Category Filter Menu -->
        <!-- Start Project Items -->
        <div class="row">
          <div class="portfolio-items">
            <!-- Start ITEM ONE Project -->
            <div class="portfolio-item apps col-xs-12 col-sm-4 col-md-3">
              <div class="recent-work-wrap">
                <img class="img-responsive" src="../images/portfolio/recent/item1.png" alt="???" title="???" />
                <div class="overlay">
                  <div class="recent-work-inner">
                    <h3>Project Title</h3>
                    <p>There are many variations of passages of Lorem Ipsum available, but the majority</p>
                    <a class="preview" href="../images/portfolio/full/item1.png" rel="prettyPhoto" alt="???" title="???"><i class="fa fa-share-square-o"></i> View</a>
                  </div><!-- recent-work-inner -->
                </div><!-- overlay -->
              </div><!-- recent-work-wrap -->
            </div><!--.portfolio-item-->
            <!-- End ITEM ONE Project -->
            ...
            </div><!--.portfolio-item wordpress html bootstrap-->
            <!-- End ITEM EIGHT Project -->
            <!-- Start ITEM NINE Project -->
            <div class="portfolio-item joomla wordpress apps col-xs-12 col-sm-4 col-md-3">
              <div class="recent-work-wrap">
                <img class="img-responsive" src="../images/portfolio/recent/item1.png" alt="???" title="???" />
                <div class="overlay">
            ...
            <!-- End ITEM NINE Project -->
            <!-- Start ITEM TEN Project -->
            <div class="portfolio-item joomla html bootstrap col-xs-12 col-sm-4 col-md-3">
              <div class="recent-work-wrap">
                <img class="img-responsive" src="../images/portfolio/recent/item1.png" alt="???" title="???" />
                <div class="overlay">
            ...
            <!-- End ITEM TEN Project -->
            <!-- Start ITEM ELEVEN Project -->
            <div class="portfolio-item wordpress html apps col-xs-12 col-sm-4 col-md-3">
              <div class="recent-work-wrap">
                <img class="img-responsive" src="../images/portfolio/recent/item1.png" alt="???" title="???" />
                <div class="overlay">
            ...
            <!-- End ITEM ELEVEN Project -->
            <!-- Start ITEM TWELVE Project -->
            <div class="portfolio-item wordpress html col-xs-12 col-sm-4 col-md-3">
              <div class="recent-work-wrap">
                <img class="img-responsive" src="../images/portfolio/recent/item1.png" alt="???" title="???" />
                <div class="overlay">
        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-6 pull-left">
              <p>&copy; 2015 marie jt vigil&mdash;all rights reserved.</p>
            </div><!-- col-sm-6 -->
            <div class="col-sm-6">
              <ul class="pull-right">
                <li><a href="../home/index.php">Home</a></li>
            ...
            <div class="container">
              <div class="row">
                <div class="col-sm-6 col-xs-4">
                  <div class="">
                    <p>
                      <span><a class="" href="mailto:marie@jtdesignsolutions.com" title="Email">  Problems with this site?</a></span>
                    </p>
                  </div><!-- ."" -->
    ...
    <!-- Up Arrow to top of page
      <div class="container">
      	 <div class="row">
      <a href="#" class="scrollup"><i class=" pull-right fa fa-arrow-up active">  Going Up</i></a>
      		  </div> row -->
    <!--  End Content Wrapper -->
    </div><!-- #wrapper -->
  </body>
