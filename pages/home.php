...
<html lang="en-US">
	...
	<body class="body-background">
		...
		<section class="card-page">
			<div class="container">
				<!-- Start Home Full Logo -->
				<div class="container">
					<div class="center">
						<img class="home-logo" src="../images/logos/jt-design-solutions-logo-tag.png" alt="???" title="???" /></a>
					</div>
					<!-- .center -->
				</div>
				<!-- container-->
						...
						<div class="column whitecard">
							<div class="col-sm-4 plan card-one">
								...
								<ul>
									...
									<li class="description">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor.</li>
									<li class="description">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor.</li>
									<li class="description">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor.</li>
									<li class="description">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor.</li>
									<li class="description">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor.</li>
