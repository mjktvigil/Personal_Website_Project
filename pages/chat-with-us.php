        ...
        <div class="testimonial">
          ...
          <div class="testimonial-inner">
            ...
            <div class="media-body">
              ...
              <span><strong>&mdash;Name Name/</strong> ?Title?</span>
            </div>
            </div><!-- media testimonial-inner -->
        </div><!-- testimonial -->
      </div><!-- .col-xs-12 col-sm-4 wow -->
    </div><!-- .container -->
    ...
    <section id="contact-page">
      <div class="container">
        ...
        <div class="row contact-wrap">
          <!-- style="display: none" within html on purpose for ajax/js script-->
          <div class="status alert alert-success" style="display: none"></div>
          <form id="main-contact-form" class="contact-form" name="contact-form" method="post" action="../php/sendemail.php">
            ...
            <div class="col-sm-5">
              <div class="form-group">
                <label>Message *</label>
                <textarea  id="message" name="message" required="required" class="form-control" rows="7"></textarea>
              </div><!-- .form-group -->                        
              <div class="form-group" >
                <span><button type="submit" name="submit" class="btn btn-primary btn-lg" required="required">Submit message</button></span>
                <span><p>* required fileds</p></span>
              </div><!-- .form-group -->
            </div><!-- .col-sm-5 -->
